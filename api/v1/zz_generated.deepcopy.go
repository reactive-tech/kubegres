...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubegresNodeSet) DeepCopyInto(out *KubegresNodeSet) {
	*out = *in
	if in.Affinity != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubegresNodeSet.
func (in *KubegresNodeSet) DeepCopy() *KubegresNodeSet {
	if in == nil {
		return nil
	}
	out := new(KubegresNodeSet)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubegresSpec) DeepCopyInto(out *KubegresSpec) {
	*out = *in
	...
	if in.NodeSets != nil {
		...
		*out = make([]KubegresNodeSet, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
