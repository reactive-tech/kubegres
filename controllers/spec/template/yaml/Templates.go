          ...
          containers:
            - name: backup-postgres
              ...
              env:
                ...
                - name: KUBEPOSTGRES_RESOURCE_NAME
                  value: toBeReplaced
...
data:
  ...
  backup_database.sh: |
    ...
    backUpFileName="$KUBEPOSTGRES_RESOURCE_NAME-backup-$fileDt.gz"
    backUpFilePath="$BACKUP_DESTINATION_FOLDER/$backUpFileName"

    echo "$dt - Starting DB backup of Kubegres resource $KUBEPOSTGRES_RESOURCE_NAME into file: $backUpFilePath";
    ...
    echo "$dt - DB backup completed for Kubegres resource $KUBEPOSTGRES_RESOURCE_NAME into file: $backUpFilePath";
