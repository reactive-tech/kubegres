...
func CreateResourcesStatesLogger(kubegresContext ctx.KubegresContext, resourcesStates states2.ResourcesStates) ResourcesStatesLogger {
...
func (r *ResourcesStatesLogger) logServiceWrapper(logLabel string, serviceWrapper states2.ServiceWrapper) {
