...
func (r *PrimaryDbCountSpecEnforcer) CreateOperationConfigForPrimaryDbDeploying() operation2.BlockingOperationConfig {

	return operation2.BlockingOperationConfig{
		OperationId:       operation2.OperationIdPrimaryDbCountSpecEnforcement,
		StepId:            operation2.OperationStepIdPrimaryDbDeploying,
...
func (r *PrimaryDbCountSpecEnforcer) activateBlockingOperation(statefulSetInstanceIndex int32) error {
	return r.blockingOperation.ActivateOperationOnStatefulSet(operation2.OperationIdPrimaryDbCountSpecEnforcement,
		operation2.OperationStepIdPrimaryDbDeploying,
