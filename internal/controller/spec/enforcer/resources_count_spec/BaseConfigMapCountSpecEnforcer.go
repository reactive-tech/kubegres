...
func CreateBaseConfigMapCountSpecEnforcer(kubegresContext ctx.KubegresContext,
	resourcesStates states.ResourcesStates,
	resourcesCreator template.ResourcesCreatorFromTemplate,
	blockingOperation *operation2.BlockingOperation) BaseConfigMapCountSpecEnforcer {
...
func (r *BaseConfigMapCountSpecEnforcer) CreateOperationConfig() operation2.BlockingOperationConfig {

	return operation2.BlockingOperationConfig{
		OperationId:       operation2.OperationIdBaseConfigCountSpecEnforcement,
		StepId:            operation2.OperationStepIdBaseConfigDeploying,
		TimeOutInSeconds:  10,
...
func (r *BaseConfigMapCountSpecEnforcer) EnforceSpec() error {
	...
	if r.blockingOperation.IsActiveOperationIdDifferentOf(operation2.OperationIdBaseConfigCountSpecEnforcement) {
		return nil
	}
...
func (r *BaseConfigMapCountSpecEnforcer) hasLastAttemptTimedOut() bool {
	return r.blockingOperation.HasActiveOperationIdTimedOut(operation2.OperationIdBaseConfigCountSpecEnforcement)
}
...
func (r *BaseConfigMapCountSpecEnforcer) activateBlockingOperationForDeployment() error {
	return r.blockingOperation.ActivateOperation(operation2.OperationIdBaseConfigCountSpecEnforcement,
		operation2.OperationStepIdBaseConfigDeploying)
}
