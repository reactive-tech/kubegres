...
func (r *ResourcesCreatorFromTemplate) CreateReplicaStatefulSet(statefulSetInstanceIndex int32) (apps.StatefulSet, error) {
	...
	initContainer.Env[2].Value = postgresSpec.Database.VolumeMount
...
func (r *ResourcesCreatorFromTemplate) initStatefulSet(
	...
	container.Env = append(container.Env, core.EnvVar{Name: ctx.EnvVarNamePgData, Value: postgresSpec.Database.VolumeMount})
