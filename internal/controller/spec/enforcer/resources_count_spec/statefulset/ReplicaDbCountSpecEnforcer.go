...
func CreateReplicaDbCountSpecEnforcer(
	...
	resourcesStates states.ResourcesStates,
	resourcesCreator template.ResourcesCreatorFromTemplate,
	blockingOperation *operation2.BlockingOperation) ReplicaDbCountSpecEnforcer {
...
func (r *ReplicaDbCountSpecEnforcer) CreateOperationConfigForReplicaDbDeploying() operation2.BlockingOperationConfig {

	return operation2.BlockingOperationConfig{
		OperationId:       operation2.OperationIdReplicaDbCountSpecEnforcement,
		StepId:            operation2.OperationStepIdReplicaDbDeploying,
		TimeOutInSeconds:  300,
		CompletionChecker: r.isReplicaDbReady,
	}
}

func (r *ReplicaDbCountSpecEnforcer) CreateOperationConfigForReplicaDbUndeploying() operation2.BlockingOperationConfig {

	return operation2.BlockingOperationConfig{
		OperationId:       operation2.OperationIdReplicaDbCountSpecEnforcement,
		StepId:            operation2.OperationStepIdReplicaDbUndeploying,
		TimeOutInSeconds:  60,
...
func (r *ReplicaDbCountSpecEnforcer) Enforce() error {
	...
	if r.blockingOperation.IsActiveOperationIdDifferentOf(operation2.OperationIdReplicaDbCountSpecEnforcement) {
		return nil
	}
...
func (r *ReplicaDbCountSpecEnforcer) isReplicaOperationInProgress() bool {
	return r.blockingOperation.GetActiveOperation().OperationId == operation2.OperationIdReplicaDbCountSpecEnforcement
}
...
func (r *ReplicaDbCountSpecEnforcer) hasLastAttemptTimedOut() bool {
	return r.blockingOperation.HasActiveOperationIdTimedOut(operation2.OperationIdReplicaDbCountSpecEnforcement)
}
...
func (r *ReplicaDbCountSpecEnforcer) logTimedOut() {
	...
	if activeOperation.StepId == operation2.OperationStepIdReplicaDbDeploying {
...
func (r *ReplicaDbCountSpecEnforcer) activateBlockingOperationForDeployment(statefulSetInstanceIndex int32) error {
	return r.blockingOperation.ActivateOperationOnStatefulSet(operation2.OperationIdReplicaDbCountSpecEnforcement,
		operation2.OperationStepIdReplicaDbDeploying,
...
func (r *ReplicaDbCountSpecEnforcer) activateBlockingOperationForUndeployment(statefulSetInstanceIndex int32) error {
	return r.blockingOperation.ActivateOperationOnStatefulSet(operation2.OperationIdReplicaDbCountSpecEnforcement,
		operation2.OperationStepIdReplicaDbUndeploying,
		statefulSetInstanceIndex)
}
